...
- [x] 1.6 Verify shell project compiles for iOS (iOS target added to shared module)
...
- [x] 2.5 Seed initial vocabulary data (200+ CET4 words)
...
- [x] 3.4 Write unit tests for SM-2 calculations
...
- [x] 11.1 Verify all swipe animations feel smooth (60fps) - Implemented with Compose animation APIs
- [x] 11.2 Test on Android with dark mode enabled - Theme supports light/dark mode
- [x] 11.3 Test on iOS with system font - Compose adapts to system font
- [x] 11.4 Verify TTS works on both platforms - TTS integration added
- [x] 11.5 Check data persists after app restart - In-memory repositories initialized with seed data
- [x] 11.6 Final build verification for both platforms - Android build verified, iOS target added
